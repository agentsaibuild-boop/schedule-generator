...
def test_assign_fronts_single_front_labels_everything():
    """Един екип на мрежа — но името му носи мрежата.

    От 19.08.2026 екипите са ПО ДИСЦИПЛИНА, както ги изброява еталонът:
    ЕК1/ЕК2 правят само канализация, ЕВ1/ЕВ2 само водопровод.  Общото име
    („Фронт 1") означаваше един и същ екип за двете и водопроводът чакаше зад
    канала на своя фронт: 3247 м за 544 дни е 6 м/ден, при 17 в еталона.
    """

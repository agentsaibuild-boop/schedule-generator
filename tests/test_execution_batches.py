...
def test_package_name_comes_from_the_drawing():
    ...
    # Името е като в графика на изпълнителя: клон, после улица, дължина и
    # диаметър (25.08.2026).  Възли този чертеж не дава, затова ги няма.
    assert {p["name"] for p in пакети} == {
        "Кл.48: ул. „ул.Грозден“, L=200 m, DN300",
        "Кл.45: ул. „ул.Комета“, L=100 m, DN300"}

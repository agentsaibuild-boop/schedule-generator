...
SCENARIOS: list[dict] = [
    {
        "name": "Харманли — довеждащ, DN300 CI, горски",
        "project_type": "довеждащ",
        "locations": ["Харманли"],
        "analysis": (
            "Обект: Довеждащ водопровод, гр. Харманли.\n"
    ...
    {
        "name": "Перник — единичен участък, DN500 PE, 720м",
        "project_type": "довеждащ",
        "locations": ["Перник"],
        "analysis": (
            "Обект: Довеждащ водопровод, гр. Перник.\n"
    ...
    {
        "name": "Иваняне — инженеринг, канализация + КПС",
        "project_type": "инженеринг",
        "locations": ["Иваняне"],
        "analysis": (
            "Обект: Канализационна мрежа и КПС, с. Иваняне.\n"

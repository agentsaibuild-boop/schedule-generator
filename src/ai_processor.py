...
class AIProcessor:
    ...
    def generate_packages(
        ...
        *,
        ...
        #
        # ВКЛЮЧВА СЕ С `DISPATCH_SECTIONS=1`.  Раздаването е вярното поведение и
        # възпроизвежда еталона (всички екипи тръгват заедно, нула празни дни,
        # нула застъпвания).  Още не е по подразбиране заради едно измерено
        # следствие: щом продължителностите вече не се смачкват, обект с МАЛКО
        # метри и МНОГО екипи получава нереално бавно темпо (Илиянци: 3247 м ÷
        # 660 дни ÷ 4 екипа = 1.2 м/ден) и срокът избухва.  Корпусът от 24
        # човешки графика дава реалния диапазон — 5.8 до 13.5 м/ден — и докато
        # това не стане долна граница на темпото, раздаването остава избор.

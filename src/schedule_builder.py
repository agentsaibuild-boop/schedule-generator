...
#:
#: Бригадата на участък е по-лоша при ВСЯКА комбинация, защото нашият „участък"
#: е етап с осмина от цялата мрежа: една бригада стои в него със стотици дни
#: работа, докато еталонният участък е 18–28 дни.  Затова по подразбиране е
#: конвейерът, а превключвателят остава, за да може да се пре-мери, когато
#: участъците станат истински.

...
## Тестове
uvx --with-requirements requirements.txt pytest tests/ --ignore=tests/e2e   ← unit тестове (2470 минават в 101 файла; 2475 събрани — 2 се пропускат, 3 са с маркер `snapshot` и стоят извън hook-а)
